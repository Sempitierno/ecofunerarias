...
const funerarias: Funeraria[] = [
  ...
  },
  {
    id: 3,
    name: "BaPets",
    method: "Aquacremación",
    desc: "Bapets utiliza un proceso llamado hidrólisis alcalina, que es una cremación en base a agua, la cual no emite gases contaminantes, ni de efecto invernadero a la atmosfera.",
    url: "https://bapets.cl",
  ...
  },
  {
    ...
    name: "Sendero",
    method: "Cremación",
    desc: "En Crematorio Sendero ofrecemos una alternativa moderna, segura y con altos estándares de calidad. Contamos con el apoyo de un equipo especializado.",
    url: "https://www.sendero.cl",
    location: "Todo Chile",
